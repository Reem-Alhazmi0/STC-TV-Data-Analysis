...
هذا المستودع يوثق مشاركتي في برنامج "مسك مهارات" للعمل الافتراضي كمحلل بيانات، حيث قمت بالعمل على مجموعة بيانات حقيقية لمنصة stc tv. الهدف من المشروع كان استخراج رؤى تحليلية (Insights)، بناء نماذج تنبؤية، وتطوير محرك توصيات ذكي لتعزيز تجربة المستخدم.
